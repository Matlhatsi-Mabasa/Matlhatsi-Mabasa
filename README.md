...
### **Aspiring Backend Developer | AWS Solutions Architect Candidate | Software Development Student**

I am a dedicated Software Development student at **Belgium Campus iTversity** with a passion for architecting the "under-the-hood" systems that power modern technology. I specialize in building robust, logic-driven applications and am currently focused on bridging the gap between clean code and scalable cloud infrastructure.

---

### **🔭 About Me**
- 🎓 **Education:** Pursuing Software Development at Belgium Campus iTversity.
- ☁️ **Cloud Expertise:** Completed the **AWS Solutions Architect** curriculum; currently preparing for the examination to master high-availability system design.
- ⚡ **Career Goal:** To excel as a **Backend Developer**, creating efficient, high-performance server-side logic and database schemas.
- 🧠 **Interests:** My analytical approach is fueled by a love for strategic gaming and psychological dramas—I enjoy dissecting complex systems, whether in a game or a codebase.
